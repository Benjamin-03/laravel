...
class InstructorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $course->slug = $slugify->slugify($request->input('title'));
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('instructor.index')->with('success', 'Vos modifications ont été apportées avec succés !');
    }
    ...
    public function publish(int $id)
    {
        ...
        return redirect()->back()->with('danger', 'Votre cours doit avoir un tarif de défini, ainsi qu\'au moins une section d\'être publiable !');
    }
