...
<div class="container">
    <div class="row">
        <div class="col-lg-8">
            <form id="payment-form" class="jumbotron row contact_form" action="{{ route('checkout.charge') }}"
                method="POST">
                @csrf
                ...
                <table class="table table-striped">
                    <tbody>
                      ...
                      @foreach(\Cart::session(Auth::user()->id)->getContent() as $course)
                        <tr>
                            <td><img class="cart-img" src="/storage/courses/{{ $course->model->user_id }}/{{ $course->model->image }}">
                            </td>
                            <td>
                                <p><b>{{$course->model->name}}</b></p>
...
<script>
    ...
    var stripe = Stripe(
        'pk_test_51HG01JLKTtJlfSVwMWxjRRmbIAieumkbHPCN48tMosvUq74OGhiCHzY3LTavtIEyoW4DhiypNLEkMNuzRTO2aT2w00ltw83cAZ'
        );
